...
use VentureApp\Slack\Message;
use VentureApp\Slack\Attachment;

class MessageUnitTest extends PHPUnit_Framework_TestCase
{
    public function testInstantiation()
    {
        $this->assertInstanceOf('VentureApp\Slack\Message', $this->getMessage());
    }
    ...
    {
        return new Message(Mockery::mock('VentureApp\Slack\Client'));
    }
}
