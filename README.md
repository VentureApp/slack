...
[![Build Status](https://travis-ci.org/VentureApp/slack.svg?branch=master)](https://travis-ci.org/VentureApp/slack)
[![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/VentureApp/slack/badges/quality-score.png?b=master)](https://scrutinizer-ci.com/g/VentureApp/slack/?branch=master)
...
* Laravel integration: [Slack for Laravel](https://github.com/VentureApp/slack-laravel)
...
```sh
composer require VentureApp/slack
```
...
$client = new VentureApp\Slack\Client('https://hooks.slack.com/...');
...
$client = new VentureApp\Slack\Client('https://hooks.slack.com/...', $settings);
```
