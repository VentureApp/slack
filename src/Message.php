...
class Message
{
     ...
     *
     * @param \VentureApp\Slack\Client $client
     * @return void
     */
    ...
    public function attach($attachment)
    {
        ...
        throw new InvalidArgumentException('Attachment must be an instance of VentureApp\\Slack\\Attachment or a keyed array');
    }
